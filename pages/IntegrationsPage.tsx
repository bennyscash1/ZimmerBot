...
app.post('/webhook', async (req, res) => {
  ...
  const result = await ai.models.generateContent({
    ...
    contents: text,
    config: { systemInstruction: "You are ZimmerPro AI assistant..." }
  });
  ...
  return (
    <div className="space-y-10 animate-fadeIn max-w-6xl mx-auto">
      <div className="text-center space-y-4">
        ...
        <h2 className="text-4xl font-black text-slate-800 tracking-tight">איך מחברים את הבוט לווצאפ?</h2>
        <p className="text-slate-500 max-w-2xl mx-auto font-medium">כדי שהבוט יעבוד בחיים האמיתיים, אנחנו צריכים לקשר בין Gemini לבין שרת WhatsApp Business API.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 relative">
         ...
         {[
           ...
           { icon: Bot, title: 'Gemini AI', desc: 'חברו את ה-API של גוגל לשרת שלכם' },
           { icon: ShieldCheck, title: 'Go Live!', desc: 'הבוט מתחיל לענות לאורחים בווצאפ' }
         ].map((step, i) => (
